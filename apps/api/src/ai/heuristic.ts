...
const GEO_LOOKUP: { patterns: RegExp[]; lat: number; lng: number }[] = [
  ...
  { patterns: [/mucuchies|mucuchíes/i], lat: 8.7500, lng: -70.9167 },
  { patterns: [/bailadores/i], lat: 8.2500, lng: -71.8167 },
  ...
  { patterns: [/guiria|güiria/i], lat: 10.5750, lng: -62.2981 },
  ...
  { patterns: [/el tigre/i], lat: 8.8833, lng: -64.2500 },
  // --- Monagas ---
  ...
  { patterns: [/upata/i], lat: 8.0167, lng: -62.4000 },
