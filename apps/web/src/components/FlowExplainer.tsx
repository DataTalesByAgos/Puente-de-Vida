const STEPS = [
  {
    ...
    desc: 'Escribe un mensaje normal: "necesitamos agua potable, somos 5 familias". Sin apps ni cuentas.',
  },
  {
    n: 2,
    icon: '🤖',
    ...
    desc: 'El bot responde al instante y la IA clasifica la categoría, la prioridad y extrae ubicación.',
  },
  {
    n: 3,
    icon: '🧭',
    ...
    desc: 'Las necesidades se ordenan por urgencia en el panel del coordinador. Un vistazo ve todo.',
  },
  {
    n: 4,
    icon: '🚑',
